...
A hands-on assignment exploring core deep learning concepts through interactive Google Colab notebooks. Each notebook covers a focused topic with code, visualizations, and explanations.
...
│
├── 01_training_techniques/
│   └── deep_learning_training_techniques.ipynb
│
├── 02_classification_metrics/
│   └── metrics_for_classification_fundamentals.ipynb
│
├── 03_hyperparameter_tuning/
│   └── hyperparameter_tuning_deep_learning.ipynb
│
├── 04_optimizers/
│   └── optimizers_for_deep_learning.ipynb
│
├── 05_activation_functions/
│   └── activation_functions_for_deep_learning.ipynb
│
├── 06_cnn/
│   └── convolutional_neural_networks.ipynb
│
├── 07_modern_cnn_transfer_learning/
│   └── modern_cnn_architectures_transfer_learning.ipynb
│
└── README.md
```
...
All notebooks run directly in Google Colab — no local setup required.

1. Click any **Open in Colab** badge above
2. Go to `Runtime → Run all` to execute the full notebook
3. Watch the linked video for a guided walkthrough of each topic
...
*[CMPE258 sec 49 Deep Learning / SJSU]*
*[2nd Term / 2026]*
